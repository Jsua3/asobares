...
- **El filtro de municipios del Directorio lista todos, tengan o no fichas.** Con la siembra de hoy la base pasa de ocho municipios a doce, así que en **desarrollo** —donde hay 24 establecimientos de demostración— el cajón ofrece cuatro opciones vacías más. ⚠️ **En producción no se ve, y conviene no escribirlo como si se viera**: el Directorio sirve sus tres cifras de cabecera en **0** y el selector solo trae «Todos los municipios», porque no hay ni un establecimiento publicado. La deuda es del código y despierta el día que se importen las fichas del gremio. Se arregla en el sembrador del directorio, no en la guía, que sí filtra bien.
