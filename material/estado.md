...
| Rama de trabajo | Ninguna abierta: `p3-barra-lateral` se fusionó en `main` el 8 sep, se conserva como historia y **está desplegada**. **Las doce tareas del plan están cerradas**: el 8 sep entraron las cuatro que faltaban —las señales del sistema, la guardia de contrato sobre el vendor, la maqueta como comando con su medición en Chromium, y la revisión adversaria— y las cuatro últimas **no están desplegadas todavía** |
...
2. **Empujar las cuatro tareas últimas de la barra lateral**, que están en `main` sin desplegar: las señales del sistema, la guardia de contrato sobre el vendor, la maqueta como comando y la revisión adversaria. Y la medición que solo puede hacer Sua: **el coste del campo de puntos en marcha**, porque el navegador de la sesión no pinta fotogramas con la ventana detrás.
