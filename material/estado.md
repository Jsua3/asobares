...
| Ramas | `p1-cierre-bolsas` y `p1-auditoria-y-metricas`, las dos **fusionadas por avance rápido y ya en producción**. ⚠️ **Desde el 9 sep por la tarde SÍ queda trabajo sin fusionar, y en cadena:** `cierre/sua` (`2cef335`, siete arreglos del bloque SUA) y encima `diseno/movimiento` (`86dcdb9`, la capa visual). Las dos **publicadas en origin y ninguna fusionada ni desplegada**; la segunda sale de la primera, así que se integran en ese orden. Esperan la revisión de Ingrid |
| Rama `diseno/movimiento` | `86dcdb9` · **siete commits**, base `cierre/sua`. Motor de resortes propio (sin dependencias nuevas), la hoja del móvil arrastrable, el vidriado del botón al pulsar, la gota de la pestaña activa, los huecos de fotografía y **dos incumplimientos de RNF-12 corregidos**. Suite sobre la rama: **1.324 casos · 1.310 pasan · 14 omitidas · 0 fallos · 6.035 aserciones**, Pint limpio, veintidós mutaciones comprobadas en rojo. **No tocó producción ni `main`** |
