...
export default defineConfig({
    plugins: [
        laravel({
            input: ['resources/css/app.css', 'resources/js/app.js', 'resources/css/filament/admin/theme.css', 'resources/js/panel-graficas.js', 'resources/js/panel-barra-lateral.js'],
            refresh: true,
            fonts: [
