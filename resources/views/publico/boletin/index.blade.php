    ...
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        @if ($noticias->isEmpty())
            <div class="tarjeta mt-8 p-12 text-center">
                ...
                <p class="mt-2 text-sm text-noche-300">El boletín se publica alrededor de una vez al mes.</p>
            </div>
        @else
                    ...
                    <article class="tarjeta tarjeta-hover flex flex-col overflow-hidden">
                        <a href="{{ route('boletin.show', $noticia) }}" class="flex flex-1 flex-col">
                            ...
                            <div class="flex flex-1 flex-col p-5">
                                ...
                                <p class="mt-2 line-clamp-3 flex-1 text-sm leading-relaxed text-noche-300">{{ $noticia->extracto }}</p>
                                <span class="mt-4 text-sm font-medium text-marca-400">Leer →</span>
                            </div>
                        </a>
                    </article>
                @endforeach
