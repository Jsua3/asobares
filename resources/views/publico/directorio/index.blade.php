...
<x-layouts.publico :titulo="ajuste('seo_directorio_titulo', 'Directorio de establecimientos — ASOBARES Quindío')"
    ...
    <div class="directorio-editorial">
        ...
        <div class="directorio-editorial-cuerpo"
             x-data="{
                 panelVisible: true,
                 drawerAbierto: false,
                 abrirDrawer() {
            ...
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:gap-8">
                ...
                <div class="directorio-editorial-panel hidden shrink-0 lg:block">
                    <button type="button"
                            x-show="! panelVisible"
                            x-cloak
                ...
                <div class="min-w-0 flex-1">
                    ...
                    @if ($publicidadDirectorio)
                        <div class="directorio-editorial-pauta">
                    ...
                    <div id="resultados">
                        ...
                        <div class="mt-6 flex flex-wrap items-center justify-between gap-4">
                            ...
                            <div class="directorio-editorial-vistas inline-flex rounded-xl border border-linea p-1" role="group" aria-label="Cambiar vista">
                        ...
                        @elseif ($vista === 'mapa')
                            <div class="directorio-editorial-mapa mt-6">
                                <x-publico.mapa :puntos="$puntos" />
                            </div>
                            @if ($puntos === [])
                            ...
                            @endif
                        @else
                            <div class="directorio-editorial-rejilla mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
