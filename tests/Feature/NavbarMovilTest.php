...
class NavbarMovilTest extends TestCase
{
     ...
     *
     * El 15 sep se subió a 84 / 78 para que no se leyera el texto entre las
     * píldoras, y no lo arreglaba: sobre la píldora la diferencia medida era
     * de 0,14 / 255. Lo que tapa ese hueco es el velo de fila desenfocado
     * (`NavbarTresEstadosTest::test_el_velo_de_fila_cubre_los_huecos_en_scroll`).
     */
