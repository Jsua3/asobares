...
class AsociadoPolicy extends PoliticaDeContenido
{
     ...
     *
     * Habilidad aparte y SOLO por propiedad, igual que
     * `VacantePolicy::verEnPortal` y por la misma razón: `view` concede por
     * permiso *o* por propiedad, así que un directivo que además sea dueño de
     * un bar --caso perfectamente real en un gremio-- entraría por el permiso
     * de panel a la galería de cualquier otro establecimiento.
     *
