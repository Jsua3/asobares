...
return [
    ...
    |
    |              ⚠️ Las fotos que sube el propietario desde /mi-cuenta/fotos
    |              nacen SIN aprobar y aun así quedan servidas por URL: no
    |              salen en la ficha pública, pero el archivo es accesible, y
    |              una foto devuelta no se borra al devolverla. El nombre es un
    |              ULID no enumerable, así que es exposición por oscuridad y no
    |              un agujero abierto. Moverlas al disco privado, o aceptar el
    |              riesgo por escrito, es una decisión abierta.
